---
name: react-web
description: React web development with hooks, React Query, Zustand; 适用于所有 React 和 Next.js 前端开发任务。强制执行测试优先原则、使用函数式组件和 Hooks、遵循 Zustand 状态管理规范。当用户请求开发新组件、页面或功能时，应自动调用本技能。
---
